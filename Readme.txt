'pip install selenium' use kore selenium python binding install korte hobe first. eitai amar main engine.

selenium documentation: https://selenium-python.readthedocs.io/installation.html

then selenium jei browser use kore automation korbe sei browser er webdriver download korte hobe.
...
ami chacci line 25 er search queryr akta list use kore bar bar search result er prothom result er prothom href attribute print korte
